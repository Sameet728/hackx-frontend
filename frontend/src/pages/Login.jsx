...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary-800 text-white flex-col justify-center px-12 relative overflow-hidden">
        <div className="relative z-10">
          <h1 className="text-5xl font-bold mb-6">Welcome Back</h1>
          <p className="text-xl text-primary-100 mb-8">
            Access real-time health insights, outbreak predictions, and environmental risk analysis for your city.
          </p>
          <div className="flex gap-4">
            <div className="p-4 bg-primary-700/50 rounded-lg backdrop-blur-sm border border-primary-600">
              <span className="block text-2xl font-bold">AI</span>
              <span className="text-sm text-primary-200">Powered Prediction</span>
            </div>
            <div className="p-4 bg-primary-700/50 rounded-lg backdrop-blur-sm border border-primary-600">
              <span className="block text-2xl font-bold">24/7</span>
              <span className="text-sm text-primary-200">Monitoring</span>
            </div>
          </div>
        </div>
        {/* Abstract Shapes */}
        <div className="absolute top-0 right-0 -mt-20 -mr-20 w-96 h-96 bg-primary-600 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob"></div>
        <div className="absolute bottom-0 left-0 -mb-20 -ml-20 w-96 h-96 bg-primary-500 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob animation-delay-2000"></div>
      </div>
